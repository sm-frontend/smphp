...
class MobileDetect
{
	...
	protected static $properties = [
		...
		'UCBrowser'        => ['UC.*Browser/[VER]', 'UCWEB/[VER]'],
	...
	{
		return (bool) preg_match(sprintf('#%s#is', $regex), (!empty($userAgent) ? $userAgent : $this->userAgent));
	}
